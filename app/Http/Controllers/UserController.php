...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        try {
            ...
            return to_route('users')->with('message','Operación realizada correctamente.');
        } catch (\Exception $th) {
            throw $th;
        }
    }
    ...
    public function profileUser(User $user)
    {
        ...
        return view('backend.pages.users.perfil-user', compact('user', 'setting'));
    }
    ...
    public function updateProfile(Request $request, User $user)
    {
        try {
            ...
            return to_route('profile.user', compact('user'))->with('message','Operación realizada correctamente.');
        } catch (Throwable $th) {
            throw $th;
        }
    }
