<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" data-toggle="collapse" href="#ui-advanced" aria-expanded="false"
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item {{ Route::currentRouteName() == 'news' ? 'active' : '' }}"> <a class="nav-link" href="{{ route('news') }}">Lista de noticias</a></li>
                    <li class="nav-item {{ Route::currentRouteName() == 'news.add' ? 'active' : '' }}"> <a class="nav-link" href="{{ route('news.add') }}">Agregar noticia</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'authorities' ? 'active' : '' }}" href="{{ route('authorities') }}">
                <i class="fas fa-minus-square menu-icon"></i>
                <span class="menu-title">Autoridad</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'document-format' ? 'active' : '' }}" href="{{ route('document-format') }}">
                <i class="fas fa-minus-square menu-icon"></i>
                <span class="menu-title">Formato documento</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'general-settings' ? 'active' : '' }}" href="{{ route('general-settings') }}">
