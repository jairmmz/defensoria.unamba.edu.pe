                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-success btn-clipboard" data-clipboard-action="cut"
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <div class="card card-inverse-secondary">
                                <div class="card-body">
                                    <p>
                                        Lorem ipsum <span class="bg-info text-white" id="clipboardExample4">dolor sit
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-info btn-clipboard" data-clipboard-action="copy"
                                    data-clipboard-target="#clipboardExample4">Copy highlighted text</button>
                            </div>
                        </div>
                    </div>
                </div>
