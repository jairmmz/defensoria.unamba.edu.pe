                            ...
                            <div class="card text-white">
                                ...
                                <div class="card-img-overlay d-flex">
                                    <div class="mt-auto text-center w-100">
                                        ...
                                        <h6 class="card-text mb-4 font-weight-normal">Nulla vitae elit libero, a pharetra
                                            augue mollis interdum.</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme lazy-load">
                        <img class="owl-lazy" src="../../images/carousel/banner_8.jpg"
                            data-src="../../images/carousel/banner_8.jpg"
                            data-src-retina="../../images/carousel/banner_8.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_10.jpg"
                            data-src="../../images/carousel/banner_10.jpg"
                            data-src-retina="../../images/carousel/banner_10.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_9.jpg"
                            data-src="../../images/carousel/banner_9.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_11.jpg"
                            data-src="../../images/carousel/banner_11.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_6.jpg"
                            data-src="../../images/carousel/banner_6.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_3.jpg"
                            data-src="../../images/carousel/banner_3.jpg" alt="image" />
                        <img class="owl-lazy" src="../../images/carousel/banner_4.jpg"
                            data-src="../../images/carousel/banner_4.jpg" alt="image" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme video-carousel">
                        <div class="item-video"><a class="owl-video"
                                href="https://www.youtube.com/watch?v=meBbDqAXago"></a></div>
                        <div class="item-video"><a class="owl-video"
                                href="https://www.youtube.com/watch?v=Pq9yPrLWMyU"></a></div>
