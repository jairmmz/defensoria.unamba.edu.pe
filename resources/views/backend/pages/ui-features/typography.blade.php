                            ...
                            <div class="row">
                                <div class="col-md-4 d-flex align-items-center">
                                    <div class="d-flex flex-row align-items-center">
                                        <i class="fa fa-compass icon-lg text-warning"></i>
                                        <p class="mb-0 ml-1">
                                            Icon-lg
                                        </p>
                                    </div>
                                ...
                                <div class="col-md-4 d-flex align-items-center">
                                    <div class="d-flex flex-row align-items-center">
                                        <i class="fa fa-compass icon-md text-success"></i>
                                        <p class="mb-0 ml-1">
                                            Icon-md
                                        </p>
                                    </div>
                                ...
                                <div class="col-md-4 d-flex align-items-center">
                                    <div class="d-flex flex-row align-items-center">
                                        <i class="fa fa-compass icon-sm text-danger"></i>
                                        <p class="mb-0 ml-1">
                                            Icon-sm
                                        </p>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <address>
                                <p class="font-weight-bold">Melody imc</p>
                                <p>
                                    695 lsom Ave,
                                </p>
                                <p>
