        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="page-description">noUiSlider is a range slider without bloat. It offers a ton off features,
                        and it is as small, lightweight and minimal as possible</p>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="page-description">The orientation setting can be used to set the slider to
                        <code>"vertical"</code> or <code>"horizontal"</code></p>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="page-description">noUiSlider will keep your values within the slider range, which saves you a
                        bunch of validation.</p>
                    <div class="template-demo">
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="page-description">The connect setting can be used to control the bar between the handles, or
                        the edges of the slider</p>
                    <div class="template-demo">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <p class="page-description">noUiSlider can provide a basic tooltip without using its events
                                system. Set the tooltips option to <code>true</code> to enable.</p>
                        ...
                        <div class="card-body">
                            ...
                            <p class="page-description">Tooltip slider with different color options, use class
                                <code>slider-*</code> to quickly create a styled slider. Uses native boostrap colors scheme
                                classes</p>
                            <div class="mt-5 pt-4 w-75 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        ...
                        <div class="slider-wrap">
                            <p class="page-description">Set type to double and specify range, also showing grid and adding
                                prefix "$"</p>
