...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">General icons</h4>
                    <p class="card-description">Use <code>fas fa-*</code> for solid icons, <code>far fa-*</code> for regular
                        icons and <code>fab fa-*</code> for brand icons</p>
                    <div class="icons-list row">
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-book"></i>fa fa-address-book </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-address-book"></i>far fa-address-book
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-address-card"></i>fa fa-address-card </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-address-card"></i>far fa-address-card
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-envelope"></i>far fa-envelopepen </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-envelope-open"></i>far fa-envelope-open
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fab fa-etsy"></i>fab fa-etsy </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fab fa-free-code-camp"></i>fab fa-free-code-camp
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fab fa-grav"></i>fab fa-grav </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-handshake"></i>far fa-handshake </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-id-card"></i>far fa-id-card </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-snowflake"></i>far fa-snowflake </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-user-circle"></i>far fa-user-circle </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-user"></i>far fa-user </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-window-close"></i>fa fa-window-close </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="far fa-window-close"></i>far fa-window-close
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-window-maximize"></i>fa fa-window-maximize
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-window-minimize"></i>fa fa-window-minimize
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-window-restore"></i>fa fa-window-restore
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="icons-list row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-down"></i>
                            fa-caret-square-down</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-left"></i>
                            fa-caret-square-left</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-right"></i>
                            fa-caret-square-right</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-up"></i> fa-caret-square-up
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fas fa-cloud-upload-alt"></i> fa-cloud-upload
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-envelope-square"></i> fa-envelope-square
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-powerpoint"></i> fa-file-powerpoint
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-flag-checkered"></i> fa-flag-checkered
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-graduation-cap"></i> fa-graduation-cap
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-location-arrow"></i> fa-location-arrow
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-mail-reply-all"></i> fa-mail-reply-all
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-microphone-slash"></i> fa-microphone-slash
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-question-circle"></i> fa-question-circle
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-send"></i> fa-send <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-send"></i> fa-send <span
                                class="text-muted">(alias)</span> </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-share-alt-square"></i> fa-share-alt-square
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="icons-list row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-excel"></i> fa-file-excel</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-image"></i> fa-file-image</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-movie"></i> fa-file-movie <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-pdf"></i> fa-file-pdf</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-photo"></i> fa-file-photo <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-picture"></i> fa-file-picture <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-powerpoint"></i> fa-file-powerpoint
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-sound"></i> fa-file-sound <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-video"></i> fa-file-video</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-word"></i> fa-file-word</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-file-zip"></i> fa-file-zip <span
                                class="text-muted">(alias)</span> </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-film"></i> fa-film</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-filter"></i> fa-filter</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-fire"></i> fa-fire</div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-share-square"></i> fa-share-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-share-square"></i> fa-share-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fas fa-shield-alt"></i> fa-shield</div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-times"></i> fa-times</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-times-circle"></i> fa-times-circle</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-times-circle"></i> fa-times-circle
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-tint"></i> fa-tint</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-toggle-down"></i> fa-toggle-down <span
                                class="text-muted">(alias)</span> </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row icons-list">
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square"></i> fa-check-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-check-square"></i> fa-check-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-circle"></i> fa-circle</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-circle"></i> fa-circle</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-dot-circle"></i> fa-dot-circle</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-minus-square"></i> fa-minus-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-minus-square"></i> fa-minus-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-plus-square"></i> fa-plus-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-plus-square"></i> fa-plus-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-square"></i> fa-square</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row icons-list">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-files"></i> fa-files</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-floppy"></i> fa-floppy</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row icons-list">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-angle-double-up"></i> fa-angle-double-up
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-arrow-circle-down"></i>
                            fa-arrow-circle-down</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-arrow-circle-left"></i>
                            fa-arrow-circle-left</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-arrow-circle-right"></i>
                            fa-arrow-circle-right</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-arrow-circle-up"></i>
                            fa-arrow-circle-up</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-arrow-circle-right"></i>
                            fa-arrow-circle-right</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-arrow-circle-up"></i> fa-arrow-circle-up
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-right"></i>
                            fa-caret-square-right</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="far fa-caret-square-up"></i>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row icons-list">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-behance-square"></i> fa-behance-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-bitbucket"></i> fa-bitbucket</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-bitbucket-square"></i>
                            fa-bitbucket-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-bitcoin"></i> fa-bitcoin <span
                                class="text-muted">(alias)</span> </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-facebook-f-square"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-ge"></i> fa-ge <span
                                class="text-muted">(alias)</span> </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-github-square"></i> fa-github-square
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-google-square"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-linkedin-in-square"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-pied-piper-alt"></i> fa-pied-piper-alt
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-pinterest"></i> fa-pinterest</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-pinterest-square"></i>
                            fa-pinterest-square</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-qq"></i> fa-qq</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-ra"></i> fa-ra <span
                                class="text-muted">(alias)</span> </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-reddit-square"></i> fa-reddit-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-renren"></i> fa-renren</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-share-alt"></i> fa-share-alt</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-share-alt-square"></i>
                            fa-share-alt-square</div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-stack-exchange"></i> fa-stack-exchange
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-stack-overflow"></i> fa-stack-overflow
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-steam"></i> fa-steam</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-steam-square"></i> fa-steam-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-stumbleupon"></i> fa-stumbleupon</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-stumbleupon-circle"></i>
                            fa-stumbleupon-circle</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-tencent-weibo"></i> fa-tencent-weibo
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-tumblr-square"></i> fa-tumblr-square
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-twitter"></i> fa-twitter</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-twitter-square"></i> fa-twitter-square
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-wechat"></i> fa-wechat <span
                                class="text-muted">(alias)</span> </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-youtube"></i> fa-youtube-play</div>
                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fab fa-youtube-square"></i> fa-youtube-square
                        </div>
                    </div>
                </div>
            </div>
