    ...
    <section class="account-section padding-top padding-bottom bg_img bg_xxl_contain bg_right_bottom">
        <div class="container">
            ...
            <div class="account-area">
                <form method="POST" action="{{ route('attention-form.save') }}" enctype="multipart/form-data"
                    autocomplete="off">
                    {{ csrf_field() }}
                    @method('POST')
                        ...
                        <div class="col-lg-6" id="profesional_school_plaintiff" style="display: none;">
                            <div class="form-group">
                                ...
                                <select name="profesional_school_plaintiff">
                                    ...
                                    <option value="1">Educación Inicial Intercultural Bilingüe: Primera y Segunda
                                        Infancia</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input name="number_phone_plaintiff" type="number" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="email_plaintiff">Correo electrónico</label>
                                <input name="email_plaintiff" type="email" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input name="description_files" type="text">
                            </div>
                        </div>
                    </div>
